...
public class Initiative_creation_sqm {
	...
	//private static final String CHROME_DRIVER_PATH=Initiative_creation_sqm.class.getClassLoader().getResource("chromedriver.exe").getPath(); 
	static int rowcount;
...
//				
	...
	public static void main(String[] args) throws Exception {
     ...
     try { 
		...
		Initiative_creation_sqm copyOfSQM33 = new Initiative_creation_sqm();
